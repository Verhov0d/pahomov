...
class AppFinanceController extends ResourceController {
  ...
  Future<Response> createFinance(
    ...
    @Bind.body() Finance finance) async {
      try {
        ...
        return AppResponse.ok(message: 'Финанс создан');
      } catch (e) {
        return AppResponse.serverError(e, message: 'Ошибка в создании финанса');
      }
    }
  ...
  Future<Response> getOneFinance(
    ...
    try {
      ...
      return AppResponse.ok(
        body: finance.backing.contents, message: "Финанс создан"
      );
    } catch (e) {
      return AppResponse.serverError(e, message: "Ошибка в создании финанса");
    }
  ...
  Future<Response> updateFinance(
    ...
    @Bind.body() Finance bodyfinance
      ...
      try {
        ...
        return AppResponse.ok(message: "Финанс обновлен");
      } catch (e) {
        return AppResponse.serverError(e);
      }
    }
  ...
  Future<Response> deleteFinance(
    ...
    try {
      ...
      return AppResponse.ok(message: "Финанс удалён");
    } catch (e) {
      return AppResponse.serverError(e, message: "Ошибка в удалении финанса");
    }
  }
}